 ...
 */
class gYearMonthTypeTest extends \PHPUnit_Framework_TestCase
{
    /**
    ...
    {
        $this->type = Type::getType('JDF.gYearMonth');
    }

    public function testName()
    {
        $this->assertEquals('JDF.gYearMonth', $this->type->getName());
    }

    public function testDateTimeConvertsToXmlValue()
    {
        $date = new DateTime('1999-05');
        $convertedValue = $this->type->convertToXmlValue($date);

        $this->assertInternalType('string', $convertedValue);
        $this->assertEquals('1999-05', $convertedValue);
    }
    ...
    public function testDateTimeConvertsToPHPValue()
    {
        ...
        $this->assertEquals('1999-05', $date->format('Y-m'));
    }

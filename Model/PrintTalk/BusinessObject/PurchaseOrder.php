...
use RDF\JobDefinitionFormatBundle\Model\PrintTalk\Pricing;
...
class PurchaseOrder extends AbstractBusinessObject
{
     ...
     *
     * @OXM\XmlElement(type="RDF\JobDefinitionFormatBundle\Model\JDF\JDF", required=true)
     */
    protected $JDF;
     ...
     *
     * @OXM\XmlElement(type="RDF\JobDefinitionFormatBundle\Model\PrintTalk\Pricing")
     */
    protected $Pricing;
